...
urlpatterns = [
    ...
    path('<int:pk>/show_profile_page',ShowProfilePageView.as_view(),name='show_profile'),
    path('<str:pk>/edit_profile_page',EditProfilePageView.as_view(),name='edit_profile'),
